...
export const game = {
  ...
  modes: [
    ...
    },
    {
      ...
      title: 'Practice',
      icon: '✏️',
      description: 'Pick one number and drill it.',
      kind: 'play',
      selection: {
        key: 'table',
        label: 'Pick a number',
    ...
    },
    {
      ...
      title: 'Addition Map',
      icon: '🗺️',
      description: 'See mastery across all 400 facts.',
      kind: 'view',
    },
  ],
  ...
  createQuestion(session) {
    ...
    const a = isPractice ? Number(session.table || 1) : randomInt(1, 20);
