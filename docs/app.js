...
const GAME_REGISTRY = {
  ...
  usstates: {
    ...
    icon: '🗺️',
    category: 'geography',
    description: 'Spot the highlighted US state. Quick Game, Practice by region, Challenge, Capitals, and States Map.',
    defaultMode: 'quick',
  ...
  europe: {
    ...
    icon: '🇪🇺',
    category: 'geography',
    description: 'Spot the highlighted European country. Quick Game, Practice by region, Challenge, Capitals, and Europe Map.',
    defaultMode: 'quick',
